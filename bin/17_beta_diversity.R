...
index_1 = c("jaccard", "bray")
index_2 = c("unifrac", "wunifrac")
all_index = c("jaccard", "bray", "unifrac", "wunifrac")
...
for(idx in index_2) { 
    for(type in ord_type) {
      assign(paste0("ordination_", type, "_", idx), ordinate(PHYLOSEQ_norm, type, idx))
    }
}
