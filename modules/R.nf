process create_phyloseq {
    ...
    publishDir "${params.outdir}/${params.r_results}/01_data", mode: 'copy', pattern: 'metadata_for_stats.tsv'
    ...
    script:
    """
    Rscript --vanilla ${baseDir}/bin/15_create_phyloseq_obj.R ${asv_table_tsv} ${metadata} metadata_for_stats.tsv ${tree} phyloseq.rds &> stats_prepare_data.log 2&>1
